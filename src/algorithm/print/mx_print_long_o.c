...
static void mx_print_dir_long_format_o(t_list *entities, const char *delim, bool print_hidden) {
	struct stat buf;
...
void mx_print_long_o(t_list *dirs, const char *delim) {
    ...
    mx_print_dir_long_format_o(dir->entities, delim, false);
}
...
void mx_print_long_o_all(t_list *dirs, const char *delim) {
    ...
    t_dir *dir = (t_dir *)dirs->data;
    mx_print_dir_long_format_o(dir->entities, delim, true);
}
